            ...
            <div class="col-lg-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Create New Order Status</h3>
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ route('admin.orderstatus.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="invalid-feedback">Order Status name field is required.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
