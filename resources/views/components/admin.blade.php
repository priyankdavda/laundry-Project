...
<body class="hold-transition sidebar-mini layout-fixed {{ Auth::user()->mode }}-mode">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        ...
                        @else
                            <img src="{{ asset('admin/images/LaundryHub.png') }}" class="img-circle elevation-2"
                                alt="User Image" height="50">
                        @endif
                    </div>
                    <div class="info">
    ...
    {{--  </footer>   --}}
    <strong>Copyright © 2025-{{ date('Y') }} Laundry Hub </strong> All rights reserved.
    </footer>
    <!-- ./wrapper -->
